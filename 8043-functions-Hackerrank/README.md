...
<pre><sider-code-explain id="sider-code-explain" data-gpts-theme="light"></sider-code-explain><code>return_type function_name(arg_type_1 arg_1, arg_type_2 arg_2, ...) {
    ...
    ...
    ...
...
<pre><sider-code-explain id="sider-code-explain" data-gpts-theme="light"></sider-code-explain><code>int sum_of_four(int a, int b, int c, int d) {
    int sum = 0;
    sum += a;
    sum += b;
    sum += c;
