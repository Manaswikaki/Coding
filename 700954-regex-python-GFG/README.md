# [Regex - Python](https://www.geeksforgeeks.org/problems/regex-python/1?page=2&category=python&sortBy=submissions)
## Easy
...
Output: 
123 34234 34 5
Your Task:This is a function problem. Do not take any input. just Complete the function numberMatcher() that takes str as input and print numbers in it, If there are no numbers then print -1.
Constraints:1 &lt;= |str|&nbsp;&lt;= 105
